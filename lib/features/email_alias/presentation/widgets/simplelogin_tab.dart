// File: lib/features/email_alias/presentation/widgets/simplelogin_tab.dart
// SimpleLogin tab content: API key setup, alias list, toggle/delete actions.
...
class SimpleLoginTab extends ConsumerWidget {
  final String searchQuery;
  const SimpleLoginTab({super.key, required this.searchQuery});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return apiKeyAsync.when(
      ...
      data: (apiKey) {
        if (apiKey == null) return const _ApiKeySetupView();
