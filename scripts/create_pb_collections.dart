...
Future<void> main(List<String> args) async {
  ...
  final collections = [
    ...
    },
    {
      ...
      'listRule': 'userId = @request.auth.id || vaultId.owner = @request.auth.id',
      'viewRule': 'userId = @request.auth.id || vaultId.owner = @request.auth.id',
      'createRule': 'vaultId.owner = @request.auth.id',
      'updateRule': 'vaultId.owner = @request.auth.id',
      'deleteRule': 'vaultId.owner = @request.auth.id || userId = @request.auth.id',
    },
    {
